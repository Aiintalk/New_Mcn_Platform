...
> 2026-08-03：Sprint25 达人档案统一以正式 `kols.id` 贯通人格定位、当前运营关联入驻资料、报告历史、七字段档案同步和下游上下文；迁移 055 保留历史未绑定记录。接口与数据库契约见 `base/MCN_M2_Base_API.md`、`base/MCN_M2_Base_Database.md`，测试证据见 `tests/M2_Sprint25_测试报告_达人档案统一_v1.md`。
